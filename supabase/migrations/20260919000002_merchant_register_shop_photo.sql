-- Migration: 20260919000002_merchant_register_shop_photo.sql
-- Description: Allow merchant_register_shop_for_user to accept an uploaded shop photo and store in providers.photos

DROP FUNCTION IF EXISTS public.merchant_register_shop_for_user(uuid, text, text, text, text, text);
